...
@section('title', __('Add New Vote'))

@section('content')
    <div class="container">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">{{ __('Add New Vote') }}</h1>
        </div>
        ...
        <form method="POST" action="{{ route('admin.votes.store') }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input id="url" type="text" class="form-control @error('title') is-invalid @enderror" name="url" value="{{ old('url') }}" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input id="site" type="text" class="form-control @error('site') is-invalid @enderror" name="site" value="{{ old('site') }}" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input id="image" type="text" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input id="ip" type="text" class="form-control @error('ip') is-invalid @enderror" name="ip" value="{{ old('ip') }}" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input id="param" type="text" class="form-control @error('param') is-invalid @enderror" name="param" value="{{ old('param') }}" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input id="reward" type="number" class="form-control @error('reward') is-invalid @enderror" name="reward" value="{{ old('reward') }}" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input id="timeout" type="number" class="form-control @error('timeout') is-invalid @enderror" name="timeout" value="{{ old('timeout') }}" required>
