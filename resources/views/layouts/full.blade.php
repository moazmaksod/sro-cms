...
<main>
    @section('breadcrumb')
        <div class="p-5 mb-5 text-center bg-body-tertiary" style="background-image: url({{ asset(config('global.site_background')) }}) !important; background-repeat: no-repeat; background-size: cover; background-position: center;">
