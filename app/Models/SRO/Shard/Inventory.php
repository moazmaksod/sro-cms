...
class Inventory extends Model
{
    ...
    {
        return Cache::remember('Inventory_'.$characterId, now()->addMinutes(config('settings.general.cache.data.character_items')), static function () use ($minSlot, $maxSlot, $characterId) {
